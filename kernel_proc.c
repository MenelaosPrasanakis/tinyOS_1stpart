...
void start_main_thread()
{
  ...
  //provided as an argument to spawn in createThread,so a new thread is made
void start_thread()
{
  int exitval;
  ...
  Task call = cur_thr->ptcb->task;
  int argl = cur_thr->ptcb->argl;
  void* args = cur_thr->ptcb->args;
